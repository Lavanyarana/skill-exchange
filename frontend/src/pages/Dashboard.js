      ...
      <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition border mb-6">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <input
            ...
            placeholder="Skills Offered (Java, HTML)"
            value={skillsOffered}
          ...
          <input
            className="p-3 border rounded-lg focus:ring-2 focus:ring-blue-400"
            placeholder="Skills Wanted (Python, Design)"
            value={skillsWanted}
        ...
        {matches.length === 0 ? (
          <div className="text-center py-10">
            ...
            <p className="text-gray-400 text-sm">
              Try adding more skills to find people
            </p>
          </div>
        ) : (
            ...
            {matches.map((user) => (
              ...
              >
                ...
                <div className="mt-3 text-sm">
                  <p>
                    <b>Offers:</b> {user.skillsOffered.join(", ")}
                  </p>
                  <p>
            ...
            {requests.map((req) => (
              ...
              >
                <p className="font-medium">
                  <b>{req.sender.name}</b> wants <b>{req.skill}</b>
                </p>
